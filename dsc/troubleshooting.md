...
* **Newest**: Accepts an integer value to indicate the number of operations to be displayed. By default, it returns 10 newest operations. For instance, TODO: Show Get-xDscOperation -Newest 5
...
For example, the following output shows results of the last operation from multiple computers: TODO: Replace picture for Get-xDscOperation to display remote computer logs
...
This will display the same results as the `Get-WinEvent` cmdlet, such as in the output below: TODO: What output?
