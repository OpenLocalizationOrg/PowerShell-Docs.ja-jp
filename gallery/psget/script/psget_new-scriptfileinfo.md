...
メタデータをスクリプト ファイルを作成します。

## 説明

新規 ScriptFileInfo コマンドレットは、スクリプトに関するメタデータを含む、PowerShell スクリプト ファイルを作成します。
...
[新しい ScriptFileInfo](http://go.microsoft.com/fwlink/?LinkId=619792)
